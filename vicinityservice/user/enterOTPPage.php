...
<!--<div class="container-fluid">-->
	<div class="row h-100 justify-content-center">
		<div class="col-12 col-sm-12 col-md-12 col-lg-6 ">
			<div class="card " style="width: 650px;height: 300px; margin-top:100px">
				<div class="card-header">OTP</div>
				<div class="card-body">
					<h6>Please Enter the otp to reset the password</h6>
						...
						<div class="row" style="margin-top:20px">
							<div class="col-12 col-sm-12 col-md-12 col-lg-10">		
								<div class="input-group">	
									...
									<input type="text"  required="required" name="otp" class="form-control" placeholder="Enter the OTP" /> 		
								</div>
							</div>
						</div>
